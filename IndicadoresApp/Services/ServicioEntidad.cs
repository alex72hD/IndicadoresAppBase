...
namespace IndicadoresApp.Services  // Definir el espacio de nombres donde se ubicará esta clase
{
    /// <summary>
    ...
    public class ServicioEntidad  // Declarar una clase pública llamada ServicioEntidad
    {
        ...
        public async Task<List<Dictionary<string, object>>?> ObtenerTodosAsync(string nombreTabla)
        {
            ...
            {
                var url = $"{nombreTabla}";  // Construir la URL usando interpolación de strings
            ...
            string valorClave)
        {
            ...
            try
            {
                ...
                var url = $"{nombreTabla}/{nombreClave}/{valorClave}";
            ...
            Dictionary<string, object> entidad)
        {
            ...
            try
            {
                var url = $"{nombreTabla}";  // Construir la URL
    ...
    string nombreTabla, string nombreSP,
    Dictionary<string, object> parametros)
    {
    try
    {
        var url = $"{nombreTabla}/ejecutar-sp";
...
// Fin de la clase ServicioEntidad